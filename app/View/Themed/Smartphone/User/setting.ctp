...
<div>
	...
	<textarea id="add_mylist" rows="10" cols="40" name="data[mylist_page]"></textarea>
	<input id="add_mylist_submit" type="submit" value="登録" />


	<h2>ページタイトル変更</h2>
	<input id="new_title" type="text" style="width:200px;" name="data[new_title]" value="" />&nbsp;
